...
При создании или сбросе пароля пользователь обязан сменить временный пароль при первом следующем входе. Администратор может активировать, блокировать и удалить пользователей.
